	...
	public class StudentManagementSystem {
		...
		public static void main(String[] args) throws NumberFormatException, IOException, SQLException, ParseException {
			...
			if (choice == 1)
			{
				...
				PreparedStatement ps = conn.prepareStatement("select * from Student_SMS where userName=?");
				...
				if (studentPassword.equals(password)) {
					...
					do {
						...
						System.out.println("======================================================================================");
						System.out.println();
						System.out.println("================ WELCOME " + userID.toUpperCase()+ " To SMS ==================");
						System.out.println();
						System.out.println("======================================================================================");
						System.out.println();
						...
						case 2:
							System.out.println();
							System.out.println("======================================================================================");
							System.out.println(" 12000/- for Java Full Stack Development ");
							System.out.println(" 22000/- for Java Full Web Development   ");
							System.out.println(" 1300/- for Web Development              ");
							System.out.println(" 4000/- for Azure                        ");
							System.out.println(" 3000/- for Software Testing             ");
							System.out.println(" 1000/- for Data Analyst                 ");
							System.out.println("======================================================================================");
							System.out.println();
							...
							String c = "Web Development";
							String d = "Azure";
							String e = "Software Testing";
							String f = "Data Analyst ";
							System.out.println("======================================================================================");
							System.out.println();
							if (courses.equals(a)) {
								System.out.println("!Please pay rupees 12000!");
								System.out.println();
								System.out.println("======================================================================================");
								

							} else if (courses.equals(b)) {
								System.out.println("!Please pay rupees 22000!");
								System.out.println();
								System.out.println("======================================================================================");
								

							} else if (courses.equals(c)) {
								System.out.println("!Please pay rupees 13000!");
								System.out.println();
                                System.out.println("======================================================================================");
							
							} else if (courses.equals(d)) {
								System.out.println("!Please pay rupees 4000!");
								System.out.println();
								System.out.println("======================================================================================");
								
							} else if (courses.equals(e)) {
								System.out.println("!Please pay rupees 3000!");
								System.out.println();
								System.out.println("======================================================================================");
